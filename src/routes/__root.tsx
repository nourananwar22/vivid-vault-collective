  ...
  head: () => ({
    meta: [
      ...
      { title: "Pixelvault — Free & Premium Wallpapers" },
      {
        name: "description",
        content:
          "Download high-resolution free and premium wallpapers, single or in bulk, across nature, urban, abstract and space collections.",
      },
      { property: "og:site_name", content: "Pixelvault" },
